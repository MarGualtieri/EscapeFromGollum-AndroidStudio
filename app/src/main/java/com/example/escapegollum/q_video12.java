...
public class q_video12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.q_video12);
        ...
        String path = "android.resource://" + getPackageName() + "/" + R.raw.q_video12;
    ...
    public void continuar(View view) {
        ...
        Intent intent = new Intent(this, r_video13.class);
